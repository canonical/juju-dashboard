  ...
  it("extracts header columns that contain ansi codes", () => {
    expect(
      ...
      JSON.stringify([
        ...
        {
          content: "\u001b[1mVersion  \u001b[0m",
          ansiTitle: "\u001b[1mVersion\u001b[0m",
          title: "Version",
          start: 27,
          end: 35,
        },
        ...
        {
          content: "\u001b[1mCharm                     \u001b[0m",
          ansiTitle: "\u001b[1mCharm\u001b[0m",
          title: "Charm",
          start: 52,
          end: 77,
        },
        {
          content: "\u001b[1mChannel  \u001b[0m",
          ansiTitle: "\u001b[1mChannel\u001b[0m",
          title: "Channel",
          start: 78,
          end: 86,
        },
        ...
        {
          content: "\u001b[1mExposed  \u001b[0m",
          ansiTitle: "\u001b[1mExposed\u001b[0m",
          title: "Exposed",
          start: 92,
          end: 100,
        },
        {
          content: "\u001b[1mMessage\u001b[0m",
          ansiTitle: "\u001b[1mMessage\u001b[0m",
          title: "Message",
          start: 101,
        },
      ]),
