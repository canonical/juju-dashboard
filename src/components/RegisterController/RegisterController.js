          ...
          <div className="p-panel__content">
            ...
            >
              ...
              <div className="p-form__group row">
                ...
                <div className="col-10">
                  <div className="p-form__control">
                    ...
                    />
                    <p className="p-form-help-text">
                      You'll typically want to use the public IP:Port address
                ...
                <div className="col-10">
                  <div className="p-form__control">
                    ...
                    <p className="p-form-help-text">
                      ...
                      <code>juju register</code> or if unchanged from the
                      default it can be retrieved by running{" "}
              ...
              <div className="row register-a-controller__submit-segment">
                <div className="col-9">
                  <p className="p-form-help-text">
                    The credentials are stored locally in your browser and can
                    be cleared on log-out.
                  </p>
                </div>
                <div className="col-3">
                  <button
