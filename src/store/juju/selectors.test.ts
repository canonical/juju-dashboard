    ...
    const modelData = {
      abc123: modelDataFactory.build({
        applications: {
          ...
          postgres: modelDataApplicationFactory.build({
            units: {
              "postgres/0": modelDataUnitFactory.build({
                "agent-status": detailedStatusFactory.build({
                  status: "rebooting",
                }),
                "workload-status": detailedStatusFactory.build({
          ...
          wordpress: modelDataApplicationFactory.build({
            units: {
              "wordpress/0": modelDataUnitFactory.build({
                "agent-status": detailedStatusFactory.build({
                  status: "allocating",
                }),
                "workload-status": detailedStatusFactory.build({
          ...
          dashboard: modelDataApplicationFactory.build({
            units: {
              "dashboard/0": modelDataUnitFactory.build({
                "agent-status": detailedStatusFactory.build({
                  status: "executing",
                }),
                "workload-status": detailedStatusFactory.build({
              ...
              "dashboard/1": modelDataUnitFactory.build({
                "agent-status": detailedStatusFactory.build({
                  status: "idle",
                }),
                "workload-status": detailedStatusFactory.build({
