...
The dashboard connects to the controller over WebSocket. The cloud-init scripts configure the URL via `python3 charms/common/src/common/config.py` using these variables:
